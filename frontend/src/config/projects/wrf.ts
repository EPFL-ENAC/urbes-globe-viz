...
const wrfVariables = (domain: string): CogVariableConfig[] => [
  {
    ...
    legend: {
      ...
      gradient: {
        stops: [
          { value: "310 K", color: "#7a0403" },
          { value: "304 K", color: "#e4460a" },
          { value: "299 K", color: "#fabc29" },
          { value: "294 K", color: "#a4fc3b" },
          { value: "289 K", color: "#1ae4b6" },
          { value: "283 K", color: "#4687fa" },
          { value: "278 K", color: "#30123b" },
        ],
        unit: "K",
      },
    },
